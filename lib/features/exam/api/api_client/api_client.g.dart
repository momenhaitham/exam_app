...
class _ExamApiClient implements ExamApiClient {
  ...
  @override
  Future<QuestionResponse> getQuestions(String examId, String token) async {
  ...
  Future<CheckAnswersResponseDto> checkAnswers(
    ...
    final _options = _setStreamType<CheckAnswersResponseDto>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CheckAnswersResponseDto _value;
    try {
      _value = CheckAnswersResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
