...
abstract class GetSubjectExamsAPIClient {
  ...
  Future<SubjectExamsDto> getSubjectExams(@Query("subject") String? subjectId,@Header("token") String? token);

  @GET(AppEndpoints.subjectExams)
  Future<SubjectExamsDto> getAllExams(@Header("token") String? token);
}