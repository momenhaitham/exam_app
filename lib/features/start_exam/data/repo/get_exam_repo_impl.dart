...
import 'package:exam_app_project/features/start_exam/domain/repo/get_exam_repo_contract.dart';
...
class GetExamRepoImpl implements GetExamRepoContract {
  ...
  @override
  Future<BaseResponse<GetExamModel>> startExam(String examId) async {
    try{
      final response = await getExamRepoContract.startExam(examId);
      switch(response){
