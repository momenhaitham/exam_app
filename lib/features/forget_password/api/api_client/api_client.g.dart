...
class _ForgetPasswordApiClient implements ForgetPasswordApiClient {
  ...
  @override
  Future<ForgetPasswordDto> forgetPassword(Map<String, dynamic> body) async {
  ...
  @override
  Future<VirefyResetCodeDto> verifyResetCode(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<VirefyResetCodeDto>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late VirefyResetCodeDto _value;
    try {
      _value = VirefyResetCodeDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
