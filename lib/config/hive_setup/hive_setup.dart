...
import 'package:exam_app_project/features/explore_tab/exam/domain/models/saved_question_model_adapter.dart';
...
import 'package:path_provider/path_provider.dart';
  ...
  Future<void> initHive()async{
    ...
    Hive.registerAdapter(SavedQuestionModelAdapter());
